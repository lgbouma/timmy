...
$\log{g_{\star}}$\dotfill &  Surface Gravity (cgs)\hspace{9pt}\dotfill &  4.48 $\pm$ 0.03  &  5 \\
%
Li EW\dotfill & 6708\AA\ Equiv{.} Width (m\AA) \dotfill & $154 \pm 9$  & 6 \\
%
$P_{\rm rot}$\dotfill & Rotation period (d)\dotfill & $3.004\pm 0.053$  & 7 \\
Age & Adopted stellar age (Myr)\dotfill & $30$--$46$  &  8 \\
% $E(B-V)$\dotfill & Reddening (mag)\dotfill & $0.06 \pm 0.02$ & 9 \\
%
Spec. Type\dotfill & Spectral Type\dotfill & 	G0V & 8 \\
%
$R_\star$\dotfill & Stellar radius ($R_\odot$)\dotfill & 1.049$\pm$0.019 & 9 \\
$F_{\rm bol}$\dotfill & Stellar bolometric flux (cgs)\dotfill & (1.967$\pm$0.046)$\times10^{-9}$ & 9 \\
$A_{\rm V}$\dotfill & Interstellar reddening (mag)\dotfill & 0.20$\pm$0.03 & 9 \\
...
$^6$FEROS spectra,
$^7$TESS light curve,
$^8$IC~2602 ages from isochrone \& lithium depletion analyses (see Section~\ref{subsec:clusterchar}),
$^9$Combined photometric SED fit and spectroscopic parameters.}
\end{flushleft}
\vspace{-0.5cm}
\end{table}

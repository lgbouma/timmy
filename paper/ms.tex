...
do a 5 subplot olympic arrangement...
...
(or could just do 2 3d plots... one of positions, one of velocities. i
like this idea best, tbh.).

...
OR could do it as a corner plot, 6 dimensions...
...
binary companions in \tn\ system, to a magnitude difference of perhaps
half the brightness of the target star.

Figure~\ref{fig:hr} also shows that the membership census of \cn\ is
likely incomplete.  We defined the reference ``neighborhood'' as the
group of at most $10^4$ randomly selected non-member stars within 5
standard deviations of the mean \cn\ 1 right ascension, declination,
and parallax.  We queried Gaia DR2 for these stars using

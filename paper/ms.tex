...
\begin{abstract}
  ...
  identical color as TOI$\,$837. Combined with spectroscopic and
  imaging constraints, hierarchical eclipsing binary scenarios are
  ruled out.  Background eclipsing binary scenarios are limited by
  speckle imaging, but formally remain a 0.2\% possibility.  TOI

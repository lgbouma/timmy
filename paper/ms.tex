...
of][]{rebull_rotation_2020}.  Instead, we interpret it as a piece of
evidence to support the claim that \tn\ is younger than $\sim
500\,{\rm Myr}$.
...
We measured the physical properties of \tn\ as follows.

The spectroscopic parameters were measured from each of the six CHIRON
spectra (Section~\ref{subsec:chiron}). We then averaged the results,
and adopted the standard deviation across the spectra as the
uncertainty.

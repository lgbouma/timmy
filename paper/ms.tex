...
than isochrone fitting.  Rather than redetermine the age of the
cluster and add another line to the table, we simply adopt the
absolute age range for \tn\ of 30--46$\,$Myr.
...
%NOTE: begs the question... is there a large population of ~30-50 Myr
%old stars for which we could measure the rotation periods, and
%clarify if the scatter of Upper Sco chills out?
...
% Figure~\ref{fig:sed}.
Mention The SED fit, looking really good with rchi2 = 1.6: 

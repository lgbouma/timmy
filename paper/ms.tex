...
\begin{abstract}
  ...
  smaller than Jupiter.  Combining the photometry with a prior on the
  stellar parameters derived from the cluster color-magnitude diagram,
  we find that the transits are grazing with $b=0.951\pm0.012$ and
  $R_{\rm p} = 0.77 \pm 0.07 \,R_{\rm Jup}$.  From radial velocity
...
growth over the next $\sim$10-100 million years through giant impacts
\citep[{\it
...
\begin{figure}[!t]
    ...
    using the El Sauce 0.36m and ASTEP400 (0.40m). Black points are
...
removed is shown in Figure~\ref{fig:phasefold}. Our fitting procedure

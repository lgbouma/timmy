...
\begin{figure*}[t!]
  ...
  and stars in the neighborhood (gray).} Members (black circles) were
  identified by \citet{cantatgaudin_gaia_2018}.  $\alpha$ denotes
  ...
  proper motion projection ($\mu_{\rm delta}$ vs{.} $\mu_{\rm
  \alpha}\cos\delta$) highlights the incomplete membership selection
  function.

...
\begin{abstract}
  ...
  Jupiter-sized.  Its transits are grazing: $b > 0.92$ at
  ...
  Jup}$ (3$\sigma$).  Grazing transits are a cause for concern, as they
  are usually indicative of astrophysical false positive scenarios.
...
\edit1{Carl TODO: please describe and correct as appropriate}
...
\begin{figure}[!t]
    ...
    size ratio, and stellar density.} The photometric data fitted in
    Section~\ref{subsec:planet} allow for nonphysical planet sizes
    ($R_{\rm p}>2R_{\rm Jup}$; $\log(R_{\rm p}/R_\star) \gtrsim -1.6$)
    due to a classic degeneracy between the planet size and impact
    parameter.  Non-planetary sizes would imply non-planetary masses,
    which are ruled out by our radial velocity measurements.  This

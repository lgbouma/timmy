...
for color0 in ['phot_bp_mean_mag', 'phot_g_mean_mag']:
    ...
    tp.plot_hr(PLOTDIR, isochrone='parsec', color0=color0)
    tp.plot_hr(PLOTDIR, isochrone='mist', color0=color0)
    tp.plot_hr(PLOTDIR, isochrone=0, color0=color0)

    tp.plot_hr(PLOTDIR, isochrone='parsec', do_cmd=1, color0=color0)
    tp.plot_hr(PLOTDIR, isochrone='mist', do_cmd=1, color0=color0)

...
def plot_rp_vs_mass_scatter(active_targets=1, specialyoung=1, show_legend=1):
    ...
    ax.scatter(mass, rp, color='darkgray', s=3, zorder=1, marker='o',
    ...
    if active_targets:
        ...
        ax.plot(target_mass, target_rp, mew=0.5, markerfacecolor='yellow',
    ...
    ax.set_xlabel(r'Planet mass [M$_\mathrm{Jup}$]')
    ...
    outpath = (
        '../results/rp_vs_mass_scatter/rp_vs_mass_scatter_{}{}.png'.
...
if __name__=='__main__':
    ...
    for show_legend in [0,1]:
        plot_rp_vs_mass_scatter(active_targets=0, specialyoung=0,

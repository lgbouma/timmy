...
priors = [
    ...
    radvel.prior.HardBounds('logk1', np.log(1), np.log(1e5)), # Positive K Prior recommended
    ...
    radvel.prior.HardBounds('jit_FEROS', 0.0, 400),
    radvel.prior.HardBounds('jit_CHIRON', 0.0, 400)
]

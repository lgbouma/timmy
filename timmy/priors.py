...
def initialize_prior_d(x_obs, modelcomponents):
    ...
    amp = 1.5e-2 # primary mode amplitude. peak to peak is a bit over 2%
    amp_mix = 0.5 # between 0 and 1
    log_Q0 = np.log(1e2) # Q of secondary oscillation. wide prior
